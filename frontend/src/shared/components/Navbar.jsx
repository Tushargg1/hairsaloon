...
export default function Navbar() {
  ...
  // The home hero sits behind the nav; keep light text only while it is in view,
  // switch to dark once the content scrolls up over it.
  ...
  return (
    <nav className={`site-nav fixed top-0 w-full z-50 backdrop-blur-md border-b border-outline-variant/15 shadow-sm transition-all duration-300 ${overHero ? 'nav-on-hero' : ''}`}>
