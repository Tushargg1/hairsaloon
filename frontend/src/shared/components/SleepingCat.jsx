// Sleeping-cat animation shown when the backend is unreachable / errors out.
    ...
    <div className="cat-loader">
      <div className="cat-wrapper">
        ...
        <div className="cat-wall">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 500 126" className="cat-wall-svg">
