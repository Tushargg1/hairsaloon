      ...
      <nav className={`site-nav fixed top-0 z-[100] w-full backdrop-blur-xl border-b border-outline-variant/10 ${overHero ? 'nav-on-hero' : ''}`}>
        ...
        {menuOpen && !notOnboarded && (
          <div id="tenant-mobile-menu"
            className={`site-menu md:hidden border-t border-outline-variant/10 backdrop-blur-sm px-4 py-4 flex flex-col items-center gap-4 text-center ${overHero ? 'nav-on-hero' : ''}`}>
